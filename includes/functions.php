...
function woo_new_product_tab_content() {
	...
	echo '<h2>Product Datasheets</h2>';
	echo '<p><a href="../../../product-datasheets" target="_blank">Click here</a> to download product datasheets.</p>';

	echo '<h2>Technical Datasheets</h2>';
	echo '<p><a href="../../../technical-datasheets" target="_blank">Click here</a> to download technical datasheets.</p>';

	echo '<h2>Safety Datasheets</h2>';
	echo '<p><a href="../../../safety-datasheets" target="_blank">Click here</a> to download safety datasheets.</p>';
